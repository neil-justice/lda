...
public class CommunityStructure {
  ...
  private final List<TIntIntHashMap> reverseIndexes = new ArrayList<>();
  ...
  private void initialiseLayers(int layer) {
    ...
    TIntIntHashMap reverseIndex = new TIntIntHashMap();
    ...
    reverseIndexes.add(reverseIndex);
  }
